 ...
 */
final class Version20250826132256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, organizer_id INT NOT NULL, state_id INT NOT NULL, campus_id INT NOT NULL, place_id INT NOT NULL, name VARCHAR(255) NOT NULL, starting_date_hour DATETIME NOT NULL, end_date_hour DATETIME NOT NULL, nb_inscriptions_max INT NOT NULL, event_info VARCHAR(500) DEFAULT NULL, poster_file VARCHAR(300) DEFAULT NULL, INDEX IDX_3BAE0AA7876C4DDA (organizer_id), INDEX IDX_3BAE0AA75D83CC1 (state_id), INDEX IDX_3BAE0AA7AF5D55E1 (campus_id), INDEX IDX_3BAE0AA7DA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
